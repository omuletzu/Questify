...
export default function Home() {
  ...
  const handleAuth = async () => {
    ...
    axiosInstance
      ...
      .then((response) => {
        const [jwtToken, userReponse] = response.data;

        localStorage.setItem("jwtToken", jwtToken);
        localStorage.setItem("isAdmin", userReponse.admin);
        localStorage.setItem("userId", userReponse.id);
              ...
              <DialogHeader>
                ...
                <DialogDescription>
                  {isSignUp
                    ...
                    : "Introduceți username-ul și parola pentru a vă autentifica."}
                </DialogDescription>
              </DialogHeader>
